...
#include "kinova_msgs/msg/detail/kinova_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinova_msgs::msg::KinovaCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinova_msgs::msg::KinovaCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kinova_msgs::msg::KinovaCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _KinovaCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const kinova_msgs::msg::KinovaCommand *>(
...
static size_t _KinovaCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_KinovaCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _KinovaCommand__callbacks = {
  "kinova_msgs::msg",
  "KinovaCommand",
...
static rosidl_message_type_support_t _KinovaCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_KinovaCommand__callbacks,
...
{
  return &kinova_msgs::msg::typesupport_fastrtps_cpp::_KinovaCommand__handle;
}
